/**
  ...
  ******************************************************************************
*/
#ifndef INC_DRIVERS_CAMERA_H_
#define INC_DRIVERS_CAMERA_H_
/* Includes ------------------------------------------------------------------*/
...
// Image size -> QVGA //
#define IMG_ROW 	480//240
#define IMG_COL   	640//320
...
/* Global Variables ---------------------------------------------------------*/
extern uint8_t frame_buffer[320 * 240];  // Frame holder //
extern uint8_t block_buffer[1 * 20 * 40]; // Buffer to store 2 bytes per pixel
extern uint8_t frame_buffer_qqqvga[80 * 60];
extern I2C_HandleTypeDef hi2c1;  	      // I2C Handler //
extern UART_HandleTypeDef huart1;
extern uint8_t frame_buffer1[160 * 120];
